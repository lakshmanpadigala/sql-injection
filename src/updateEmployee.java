...
public class updateEmployee {
    ...
    public updateEmployee(String eid,boolean mode) {
        safemode=mode;
        ...
        id10.setFont(new Font("serif",Font.BOLD,15));
        id15.add(id10);
        f.setVisible(false);
        t9=new JTextField();
    ...
    private void actionPerformed(ActionEvent actionEvent) {
        if(actionEvent.getSource()==b && i==1){
            try{
    ...
    private void showData(String eid) {
        System.out.println("Employee Id:"+eid+" From show data");
        try{
            connection con = new connection();
            String str = "select * from employee where emp_id = "+eid+";";
