...
public class printData {
    ...
    boolean safemode=login_page.safeMode;
    public printData(String eid,boolean mode) {
        try{

            connection co = new connection();
            String str="";
            if(safemode)
                str = "select * from employee where emp_id ='"+eid+"';";
            else
                str = "select * from employee where emp_id ='"+eid+"';";
            //String str="select * from employee where emp_id ='1001' UNION SELECT 1,@@version,2,3,4,5,6,7,8,9,10;";
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Invalid Input--Sql Injection");
        }
        ...
        aid.setBounds(200,70,400,30);
        aid.setFont(new Font("serif",Font.BOLD,15));
        id9.add(aid);
